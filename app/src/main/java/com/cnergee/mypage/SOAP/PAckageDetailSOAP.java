...
public class PAckageDetailSOAP {
	...
	public void setPackageDetails(SoapObject response,
		...
		if(response.hasProperty("EBS"))
			packagedetails.setIs_ebs(Integer.parseInt(response.getPropertyAsString("EBS").toString()));
		else
			packagedetails.setIs_ebs(0);


		if(response.hasProperty("Billdesk"))
			packagedetails.setIs_Billdesk(Integer.parseInt(response.getPropertyAsString("Billdesk").toString()));
		else
			packagedetails.setIs_Billdesk(0);
...
//			packagedetails.setIs_billdesk(0);
//		}
//		if(response.hasProperty("BillDesk_Message"))
//			Utils.BILLDESK_MESSAGE=response.getPropertyAsString("BillDesk_Message").toString();
//
//		if(response.hasProperty("AvantGarde")){
//			packagedetails.setIs_avantGarde(Integer.parseInt(response.getPropertyAsString("AvantGarde").toString()));
//		}else{
//			packagedetails.setIs_avantGarde(0);
//		}
